...
<div class="main-content">
    ...
    <form action="{{ route('profile.update') }}" method="POST">
        ...
        <input type="text" inputmode="numeric" name="graduation_year" 
               value="{{ old('graduation_year', $student_profile->graduation_year) }}" required>

        <label>Phone Number</label>
        <input type="text" name="phone" 
               value="{{ old('phone', $student_profile->phone) }}" required>

        <label>Major(s)</label>
        <input type="text" name="major" 
               value="{{ old('major', $student_profile->major) }}" placeholder="e.g. Computer Science, COS">

        <label>Club(s)</label>
        <input type="text" name="club" 
               value="{{ old('club', $student_profile->club) }}">
